...
$regValues = @{
    "InactivityTimeoutSecs" = @{ Data = "0"; Type = "Dword" } 
}
...
if (-not (Test-Path $regPath)) {
    try {
        ...
        New-Item -Path HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System -Name InactivityTimeoutSecs -Force | Out-Null
